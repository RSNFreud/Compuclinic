<?php 
  ...
  $mail->AddReplyTo($emailaddress, $user);
  ...
  $mail->Body = '<div style="background-color: #dfe8ef; padding: 20px; margin: 0; box-sizing: border-box; width: 100%;">
    <table style="background-color: white; padding: 30px; box-sizing: border-box; border-radius: 10px; font-family: Helvetica Neue; width: 100%;">
        <tr style="color: grey; font-style: italic; margin-bottom: 10px;">
            <td>"'.$message.'"</td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>You have received a new message from '.$user .'! Please go to your admin panel to approve or deny it.</td>
        </tr>
        <tr>
            <td align="center">
